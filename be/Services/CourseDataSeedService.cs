...
{
    public class CourseDataSeedService : IDataSeedService
    {
        private readonly MongoDbContext _context;
        private readonly ILogger<CourseDataSeedService> _logger;

        public CourseDataSeedService(MongoDbContext context, ILogger<CourseDataSeedService> logger)
        {
            _context = context;
            _logger = logger;
        }
